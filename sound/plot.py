...
with open('data_0_clean.txt', 'r') as file:
...
with open('data_0_human.txt', 'r') as file:
...
with open('data_1_clean.txt', 'r') as file:
...
with open('data_1_human.txt', 'r') as file:
...
x_1 = [i / 500 for i in range(len(data_0_human))]
y_1 = data_0_human

x_2 = [i / 500 for i in range(len(data_1_human))]
y_2 = data_1_human
...
plt.xlabel(r'$t, мс$')
plt.text(0.2, 500, f't_1 = {t_1} с \n'
         f't_2 = {t_2} с \n'
         f'c = {round(1.158 / (t_2 - t_1) * 1000, 2)} м/с',
